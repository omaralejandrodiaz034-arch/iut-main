    ...
    <div class="bg-white shadow-sm rounded-lg p-6 space-y-6 border border-gray-100">
        ...
        <div class="bg-indigo-50 border border-indigo-200 rounded-lg p-4">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-lg font-semibold text-indigo-800">Transferir Bien</h3>
                    <p class="text-sm text-indigo-600">Mover este bien a otra dependencia</p>
                </div>
                <a href="{{ route('bienes.transferir.form', $bien) }}"
                   class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-indigo-600 border border-transparent rounded-lg hover:bg-indigo-700 transition focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-1">
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-lg font-semibold text-blue-800">Último Acta de Traslado</h3>
                    <p class="text-sm text-blue-600">
                        Generada el {{ $ultimoTraslado->fecha?->format('d/m/Y') }}
                    </p>
                </div>
                <a href="{{ Storage::disk('public')->url($ultimoTraslado->acta_path) }}" target="_blank"
